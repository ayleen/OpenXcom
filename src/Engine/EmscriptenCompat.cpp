 ...
 *
 * Phase 7: all engine surfaces are ARGB8888.  The 8bpp palette reverse-lookup
 * helpers (_gfx_pal_idx, _gfx_hline) and their callers' 8bpp branches are
 * removed.  SDL_gfx colour arguments are packed as RGBA (r<<24|g<<16|b<<8|a);
