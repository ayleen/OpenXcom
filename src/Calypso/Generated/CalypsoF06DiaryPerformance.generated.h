...
// Canonical source: src/Calypso/Contracts/f06-diary-performance.json
#pragma once
#include <cstdint>
namespace OpenXcom { namespace Calypso { namespace CalypsoF06DiaryPerformanceGen {
inline constexpr const char* kContractVersion = "hd.2026-08-29.1";
inline constexpr const char* kFormId = "f06-diary-performance";
inline constexpr int kFamilyId = 6;
inline constexpr const char* kArchetype = "selection-list";
inline constexpr const char* kSourceConfig = "FormConfigs/f06-diary-performance.json";

inline constexpr const char* kProtocol = "CALYPSO COMMAND · SERVICE HISTORY SH-06P";
inline constexpr const char* kTitle = "Service Performance";
...
struct CalypsoF06DiaryPerformanceGenButton { const char* id; const char* label; const char* tone; const char* action; std::uint32_t fill; std::uint32_t border; std::uint32_t text; };
inline constexpr CalypsoF06DiaryPerformanceGenButton kButtons[] = {
...
struct CalypsoF06DiaryPerformanceGenRect { int x; int y; int w; int h; };
struct CalypsoF06DiaryPerformanceGenLayout { int designWidth; int designHeight; int rowHeight; int visibleRows; int scrollBarWidth; int minThumbHeight; CalypsoF06DiaryPerformanceGenRect window; CalypsoF06DiaryPerformanceGenRect status; CalypsoF06DiaryPerformanceGenRect title; CalypsoF06DiaryPerformanceGenRect list; CalypsoF06DiaryPerformanceGenRect footer;
};
inline constexpr CalypsoF06DiaryPerformanceGenLayout kLayouts[] = {
...
inline constexpr CalypsoF06DiaryPerformanceGenRect kRowSlotsWide[] = {
...
inline constexpr CalypsoF06DiaryPerformanceGenRect kRowSlotsCompact[] = {
...
struct CalypsoF06DiaryPerformanceGenButtonRect { const char* id; CalypsoF06DiaryPerformanceGenRect rect; };
inline constexpr CalypsoF06DiaryPerformanceGenButtonRect kButtonRects[][ 1 ] = {
...
inline const CalypsoF06DiaryPerformanceGenLayout* layoutForDesign(int dw, int dh)
{
