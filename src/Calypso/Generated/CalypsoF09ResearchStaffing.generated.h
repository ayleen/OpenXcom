...
struct CalypsoF09ResearchStaffingGenTypography
{
	int title;
	int detailTitle;
	int body;
...
inline constexpr CalypsoF09ResearchStaffingGenTypography kTypographyWide = {
	28, 18, 14, 12, 15, 14, 14
};
inline constexpr CalypsoF09ResearchStaffingGenTypography kTypographyCompact = {
