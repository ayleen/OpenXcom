...
// Canonical source: src/Calypso/Contracts/f03-build-facilities.json
#pragma once
#include <cstdint>
namespace OpenXcom { namespace Calypso { namespace CalypsoF03BuildFacilitiesGen {
inline constexpr const char* kContractVersion = "hd.2026-08-29.1";
inline constexpr const char* kFormId = "f03-build-facilities";
inline constexpr int kFamilyId = 3;
inline constexpr const char* kArchetype = "selection-list";
inline constexpr const char* kSourceConfig = "FormConfigs/f03-build-facilities.json";

inline constexpr const char* kProtocol = "CALYPSO COMMAND · FACILITY REQUISITION FB-03";
inline constexpr const char* kTitle = "Installation";
...
struct CalypsoF03BuildFacilitiesGenButton { const char* id; const char* label; const char* tone; const char* action; std::uint32_t fill; std::uint32_t border; std::uint32_t text; };
inline constexpr CalypsoF03BuildFacilitiesGenButton kButtons[] = {
...
inline constexpr CalypsoF03BuildFacilitiesGenRect kRowSlotsCompact[] = {
...
struct CalypsoF03BuildFacilitiesGenButtonRect { const char* id; CalypsoF03BuildFacilitiesGenRect rect; };
inline constexpr CalypsoF03BuildFacilitiesGenButtonRect kButtonRects[][ 1 ] = {
...
inline const CalypsoF03BuildFacilitiesGenLayout* layoutForDesign(int dw, int dh)
{
