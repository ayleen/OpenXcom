...
// Canonical source: src/Calypso/Contracts/f05-soldier-armor.json
#pragma once
#include <cstdint>
namespace OpenXcom { namespace Calypso { namespace CalypsoF05SoldierArmorGen {
inline constexpr const char* kContractVersion = "hd.2026-08-29.1";
inline constexpr const char* kFormId = "f05-soldier-armor";
inline constexpr int kFamilyId = 5;
inline constexpr const char* kArchetype = "selection-list";
inline constexpr const char* kSourceConfig = "FormConfigs/f05-soldier-armor.json";
...
struct CalypsoF05SoldierArmorGenButton { const char* id; const char* label; const char* tone; const char* action; std::uint32_t fill; std::uint32_t border; std::uint32_t text; };
inline constexpr CalypsoF05SoldierArmorGenButton kButtons[] = {
...
struct CalypsoF05SoldierArmorGenRect { int x; int y; int w; int h; };
struct CalypsoF05SoldierArmorGenLayout { int designWidth; int designHeight; int rowHeight; int visibleRows; int scrollBarWidth; int minThumbHeight; CalypsoF05SoldierArmorGenRect window; CalypsoF05SoldierArmorGenRect status; CalypsoF05SoldierArmorGenRect title; CalypsoF05SoldierArmorGenRect list; CalypsoF05SoldierArmorGenRect footer;
};
inline constexpr CalypsoF05SoldierArmorGenLayout kLayouts[] = {
...
inline constexpr CalypsoF05SoldierArmorGenRect kRowSlotsWide[] = {
...
inline constexpr CalypsoF05SoldierArmorGenRect kRowSlotsCompact[] = {
...
struct CalypsoF05SoldierArmorGenButtonRect { const char* id; CalypsoF05SoldierArmorGenRect rect; };
inline constexpr CalypsoF05SoldierArmorGenButtonRect kButtonRects[][ 1 ] = {
...
inline const CalypsoF05SoldierArmorGenLayout* layoutForDesign(int dw, int dh)
{
