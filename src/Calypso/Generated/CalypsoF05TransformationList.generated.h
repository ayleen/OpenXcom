...
// Canonical source: src/Calypso/Contracts/f05-transformation-list.json
#pragma once
#include <cstdint>
namespace OpenXcom { namespace Calypso { namespace CalypsoF05TransformationListGen {
inline constexpr const char* kContractVersion = "hd.2026-08-29.1";
inline constexpr const char* kFormId = "f05-transformation-list";
inline constexpr int kFamilyId = 5;
inline constexpr const char* kArchetype = "selection-list";
inline constexpr const char* kSourceConfig = "FormConfigs/f05-transformation-list.json";

inline constexpr const char* kProtocol = "CALYPSO COMMAND · PERSONNEL DOSSIER PD-05";
inline constexpr const char* kTitle = "Transformations";
...
struct CalypsoF05TransformationListGenButton { const char* id; const char* label; const char* tone; const char* action; std::uint32_t fill; std::uint32_t border; std::uint32_t text; };
inline constexpr CalypsoF05TransformationListGenButton kButtons[] = {
...
struct CalypsoF05TransformationListGenRect { int x; int y; int w; int h; };
struct CalypsoF05TransformationListGenLayout { int designWidth; int designHeight; int rowHeight; int visibleRows; int scrollBarWidth; int minThumbHeight; CalypsoF05TransformationListGenRect window; CalypsoF05TransformationListGenRect status; CalypsoF05TransformationListGenRect title; CalypsoF05TransformationListGenRect list; CalypsoF05TransformationListGenRect footer;
};
inline constexpr CalypsoF05TransformationListGenLayout kLayouts[] = {
...
inline constexpr CalypsoF05TransformationListGenRect kRowSlotsWide[] = {
...
inline constexpr CalypsoF05TransformationListGenRect kRowSlotsCompact[] = {
...
struct CalypsoF05TransformationListGenButtonRect { const char* id; CalypsoF05TransformationListGenRect rect; };
inline constexpr CalypsoF05TransformationListGenButtonRect kButtonRects[][ 1 ] = {
...
inline const CalypsoF05TransformationListGenLayout* layoutForDesign(int dw, int dh)
{
