...
// Canonical source: src/Calypso/Contracts/f05-soldier-avatar.json
#pragma once
#include <cstdint>
namespace OpenXcom { namespace Calypso { namespace CalypsoF05SoldierAvatarGen {
inline constexpr const char* kContractVersion = "hd.2026-08-29.1";
inline constexpr const char* kFormId = "f05-soldier-avatar";
inline constexpr int kFamilyId = 5;
inline constexpr const char* kArchetype = "selection-list";
inline constexpr const char* kSourceConfig = "FormConfigs/f05-soldier-avatar.json";

inline constexpr const char* kProtocol = "CALYPSO COMMAND · PERSONNEL DOSSIER PD-05";
inline constexpr const char* kTitle = "Avatar";
...
struct CalypsoF05SoldierAvatarGenButton { const char* id; const char* label; const char* tone; const char* action; std::uint32_t fill; std::uint32_t border; std::uint32_t text; };
inline constexpr CalypsoF05SoldierAvatarGenButton kButtons[] = {
    { "cancel", "CANCEL", "safe", "cancel", 0x051417B8u, 0x74FFB0CCu, 0xE8FFF5FFu },
    { "apply", "APPLY", "primary", "apply", 0x74FFB0FFu, 0x74FFB0FFu, 0x071013FFu },
};
...
struct CalypsoF05SoldierAvatarGenRect { int x; int y; int w; int h; };
struct CalypsoF05SoldierAvatarGenLayout { int designWidth; int designHeight; int rowHeight; int visibleRows; int scrollBarWidth; int minThumbHeight; CalypsoF05SoldierAvatarGenRect window; CalypsoF05SoldierAvatarGenRect status; CalypsoF05SoldierAvatarGenRect title; CalypsoF05SoldierAvatarGenRect list; CalypsoF05SoldierAvatarGenRect footer;
};
inline constexpr CalypsoF05SoldierAvatarGenLayout kLayouts[] = {
...
inline constexpr CalypsoF05SoldierAvatarGenRect kRowSlotsWide[] = {
...
inline constexpr CalypsoF05SoldierAvatarGenRect kRowSlotsCompact[] = {
...
struct CalypsoF05SoldierAvatarGenButtonRect { const char* id; CalypsoF05SoldierAvatarGenRect rect; };
inline constexpr CalypsoF05SoldierAvatarGenButtonRect kButtonRects[][ 2 ] = {
    { { "cancel", { 582, 521, 158, 44 } }, { "apply", { 750, 521, 158, 44 } } }, // wide
    { { "cancel", { 332, 291, 148, 44 } }, { "apply", { 490, 291, 148, 44 } } }, // compact
};
...
inline const CalypsoF05SoldierAvatarGenLayout* layoutForDesign(int dw, int dh)
{
