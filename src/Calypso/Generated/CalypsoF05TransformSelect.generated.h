...
// Canonical source: src/Calypso/Contracts/f05-transform-select.json
#pragma once
#include <cstdint>
namespace OpenXcom { namespace Calypso { namespace CalypsoF05TransformSelectGen {
inline constexpr const char* kContractVersion = "hd.2026-08-29.1";
inline constexpr const char* kFormId = "f05-transform-select";
inline constexpr int kFamilyId = 5;
inline constexpr const char* kArchetype = "selection-list";
inline constexpr const char* kSourceConfig = "FormConfigs/f05-transform-select.json";
...
struct CalypsoF05TransformSelectGenButton { const char* id; const char* label; const char* tone; const char* action; std::uint32_t fill; std::uint32_t border; std::uint32_t text; };
inline constexpr CalypsoF05TransformSelectGenButton kButtons[] = {
...
struct CalypsoF05TransformSelectGenRect { int x; int y; int w; int h; };
struct CalypsoF05TransformSelectGenLayout { int designWidth; int designHeight; int rowHeight; int visibleRows; int scrollBarWidth; int minThumbHeight; CalypsoF05TransformSelectGenRect window; CalypsoF05TransformSelectGenRect status; CalypsoF05TransformSelectGenRect title; CalypsoF05TransformSelectGenRect list; CalypsoF05TransformSelectGenRect footer;
};
inline constexpr CalypsoF05TransformSelectGenLayout kLayouts[] = {
...
inline constexpr CalypsoF05TransformSelectGenRect kRowSlotsWide[] = {
...
inline constexpr CalypsoF05TransformSelectGenRect kRowSlotsCompact[] = {
...
struct CalypsoF05TransformSelectGenButtonRect { const char* id; CalypsoF05TransformSelectGenRect rect; };
inline constexpr CalypsoF05TransformSelectGenButtonRect kButtonRects[][ 1 ] = {
...
inline const CalypsoF05TransformSelectGenLayout* layoutForDesign(int dw, int dh)
{
