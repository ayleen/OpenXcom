...
// Canonical source: src/Calypso/Contracts/f06-soldier-memorial.json
#pragma once
#include <cstdint>
namespace OpenXcom { namespace Calypso { namespace CalypsoF06SoldierMemorialGen {
inline constexpr const char* kContractVersion = "hd.2026-08-29.1";
inline constexpr const char* kFormId = "f06-soldier-memorial";
inline constexpr int kFamilyId = 6;
inline constexpr const char* kArchetype = "selection-list";
inline constexpr const char* kSourceConfig = "FormConfigs/f06-soldier-memorial.json";

inline constexpr const char* kProtocol = "CALYPSO COMMAND · PERSONNEL DOSSIER PD-06";
inline constexpr const char* kTitle = "Memorial";
...
struct CalypsoF06SoldierMemorialGenButton { const char* id; const char* label; const char* tone; const char* action; std::uint32_t fill; std::uint32_t border; std::uint32_t text; };
inline constexpr CalypsoF06SoldierMemorialGenButton kButtons[] = {
...
struct CalypsoF06SoldierMemorialGenRect { int x; int y; int w; int h; };
struct CalypsoF06SoldierMemorialGenLayout { int designWidth; int designHeight; int rowHeight; int visibleRows; int scrollBarWidth; int minThumbHeight; CalypsoF06SoldierMemorialGenRect window; CalypsoF06SoldierMemorialGenRect status; CalypsoF06SoldierMemorialGenRect title; CalypsoF06SoldierMemorialGenRect list; CalypsoF06SoldierMemorialGenRect footer;
};
inline constexpr CalypsoF06SoldierMemorialGenLayout kLayouts[] = {
...
inline constexpr CalypsoF06SoldierMemorialGenRect kRowSlotsWide[] = {
...
inline constexpr CalypsoF06SoldierMemorialGenRect kRowSlotsCompact[] = {
...
struct CalypsoF06SoldierMemorialGenButtonRect { const char* id; CalypsoF06SoldierMemorialGenRect rect; };
inline constexpr CalypsoF06SoldierMemorialGenButtonRect kButtonRects[][ 1 ] = {
...
inline const CalypsoF06SoldierMemorialGenLayout* layoutForDesign(int dw, int dh)
{
