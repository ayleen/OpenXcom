...
// Canonical source: src/Calypso/Contracts/f06-diary-mission.json
#pragma once
#include <cstdint>
namespace OpenXcom { namespace Calypso { namespace CalypsoF06DiaryMissionGen {
inline constexpr const char* kContractVersion = "hd.2026-08-29.1";
inline constexpr const char* kFormId = "f06-diary-mission";
inline constexpr int kFamilyId = 6;
inline constexpr const char* kArchetype = "selection-list";
inline constexpr const char* kSourceConfig = "FormConfigs/f06-diary-mission.json";

inline constexpr const char* kProtocol = "CALYPSO COMMAND · SERVICE HISTORY SH-06M";
inline constexpr const char* kTitle = "Mission Detail";
...
struct CalypsoF06DiaryMissionGenButton { const char* id; const char* label; const char* tone; const char* action; std::uint32_t fill; std::uint32_t border; std::uint32_t text; };
inline constexpr CalypsoF06DiaryMissionGenButton kButtons[] = {
...
struct CalypsoF06DiaryMissionGenRect { int x; int y; int w; int h; };
struct CalypsoF06DiaryMissionGenLayout { int designWidth; int designHeight; int rowHeight; int visibleRows; int scrollBarWidth; int minThumbHeight; CalypsoF06DiaryMissionGenRect window; CalypsoF06DiaryMissionGenRect status; CalypsoF06DiaryMissionGenRect title; CalypsoF06DiaryMissionGenRect list; CalypsoF06DiaryMissionGenRect footer;
};
inline constexpr CalypsoF06DiaryMissionGenLayout kLayouts[] = {
...
inline constexpr CalypsoF06DiaryMissionGenRect kRowSlotsWide[] = {
...
inline constexpr CalypsoF06DiaryMissionGenRect kRowSlotsCompact[] = {
...
struct CalypsoF06DiaryMissionGenButtonRect { const char* id; CalypsoF06DiaryMissionGenRect rect; };
inline constexpr CalypsoF06DiaryMissionGenButtonRect kButtonRects[][ 1 ] = {
...
inline const CalypsoF06DiaryMissionGenLayout* layoutForDesign(int dw, int dh)
{
