...
// Canonical source: src/Calypso/Contracts/f06-diary-light.json
#pragma once
#include <cstdint>
namespace OpenXcom { namespace Calypso { namespace CalypsoF06DiaryLightGen {
inline constexpr const char* kContractVersion = "hd.2026-08-29.1";
inline constexpr const char* kFormId = "f06-diary-light";
inline constexpr int kFamilyId = 6;
inline constexpr const char* kArchetype = "selection-list";
inline constexpr const char* kSourceConfig = "FormConfigs/f06-diary-light.json";

inline constexpr const char* kProtocol = "CALYPSO COMMAND · SERVICE HISTORY SH-06C";
inline constexpr const char* kTitle = "Combat Record";
...
struct CalypsoF06DiaryLightGenButton { const char* id; const char* label; const char* tone; const char* action; std::uint32_t fill; std::uint32_t border; std::uint32_t text; };
inline constexpr CalypsoF06DiaryLightGenButton kButtons[] = {
...
struct CalypsoF06DiaryLightGenRect { int x; int y; int w; int h; };
struct CalypsoF06DiaryLightGenLayout { int designWidth; int designHeight; int rowHeight; int visibleRows; int scrollBarWidth; int minThumbHeight; CalypsoF06DiaryLightGenRect window; CalypsoF06DiaryLightGenRect status; CalypsoF06DiaryLightGenRect title; CalypsoF06DiaryLightGenRect list; CalypsoF06DiaryLightGenRect footer;
};
inline constexpr CalypsoF06DiaryLightGenLayout kLayouts[] = {
...
inline constexpr CalypsoF06DiaryLightGenRect kRowSlotsWide[] = {
...
inline constexpr CalypsoF06DiaryLightGenRect kRowSlotsCompact[] = {
...
struct CalypsoF06DiaryLightGenButtonRect { const char* id; CalypsoF06DiaryLightGenRect rect; };
inline constexpr CalypsoF06DiaryLightGenButtonRect kButtonRects[][ 1 ] = {
...
inline const CalypsoF06DiaryLightGenLayout* layoutForDesign(int dw, int dh)
{
