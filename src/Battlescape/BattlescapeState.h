...
public:
	...
	/// Draw one stat number as a TTF value inside a coloured rounded box (imgSlot = Map HudImageSlot).
	void applyHudNumber(NumberText* w, int value, Uint32 accentArgb, int imgSlot);
